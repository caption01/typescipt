...
},{"./View":"src/view/View.ts"}],"src/view/UserList.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  UserList.prototype.renderItem = function (model, parentItem) {
    new UserShow_1.UserShow(parentItem, model).render();
  };
...
},{"./CollectionView":"src/view/CollectionView.ts","./UserShow":"src/view/UserShow.ts"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
function () {
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (resp) {
...
exports.Attribuites = void 0;

var Attribuites =
/** @class */
function () {
  function Attribuites(data) {
    var _this = this;
...
exports.Attribuites = Attribuites;
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attributes_1.Attribuites(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
  };
...
exports.User = User;
},{"./Model":"src/model/Model.ts","./Attributes":"src/model/Attributes.ts","./ApiSync":"src/model/ApiSync.ts","./Eventing":"src/model/Eventing.ts","./Collection":"src/model/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
users.fetch();
},{"./view/UserList":"src/view/UserList.ts","./model/Collection":"src/model/Collection.ts","./model/User":"src/model/User.ts"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
